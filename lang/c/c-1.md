...
int main()
{
   int arr2d[2][3] = {{1, 2, 3}, {6, 7, 8}};
   int len2d1 = sizeof(arr2d) / sizeof(arr2d[0]);
   int len2d2 = sizeof(arr2d[0]) / sizeof(arr2d[0][0]);
   for (int i = 0; i < len2d1; i++)
      for (int j = 0; j < len2d2; j++)
         printf("arr2d[%d][%d] = %X -> %d\n", i, j, &arr2d[i][j], arr2d[i][j]);

   int *ptr2d = &arr2d[0][0];
   for (int i = 0; i < len2d1; i++)
      for (int j = 0; j < len2d2; j++)
         printf("%d, %d: %X -> %d\n", i, j, ptr2d + i * len2d2 + j, *(ptr2d + i * len2d2 + j));

   int(*ptr2ptr2d)[3] = arr2d;
   for (int i = 0; i < len2d1; i++)
      for (int j = 0; j < len2d2; j++)
         printf("%d, %d: %X -> %d\n", i, j, *(ptr2ptr2d + i) + j, *(*(ptr2ptr2d + i) + j));

   int arr3d[2][3][1] = {{{1}, {2}, {3}}, {{6}, {7}, {8}}};
   int len3d1 = sizeof(arr3d) / sizeof(arr3d[0]);
   int len3d2 = sizeof(arr3d[0]) / sizeof(arr3d[0][0]);
   int len3d3 = sizeof(arr3d[0][0]) / sizeof(arr3d[0][0][0]);
   for (int i = 0; i < len3d1; i++)
      for (int j = 0; j < len3d2; j++)
         for (int k = 0; k < len3d3; k++)
            printf("arr3d[%d][%d][%d] = %X -> %d\n", i, j, k, &arr3d[i][j][k], arr3d[i][j][k]);

   int(*ptr3d)[3][1] = arr3d;
   for (int i = 0; i < len3d1; i++)
      for (int j = 0; j < len3d2; j++)
         for (int k = 0; k < len3d3; k++)
            printf("%d, %d, %d = %X -> %d\n", i, j, k, *(*(ptr3d + i) + j) + k, *(*(*(ptr3d + i) + j) + k));
