...
```bash
# check support
sle15:~ # grep -E "(vmx|svm)" /proc/cpuinfo  # for intel -> vmx, for amd -> svm
sle15:~ # dmesg | grep -e DMAR -e IOMMU      # for intel
sle15:~ # dmesg | grep AMD-Vi                # for amd

# check device
sle15:~ # lspci | grep -i ethernet
sle15:~ # lspci -s <bus>:<device>.<func> -v | grep -i sr-iov
sle15:~ # lspci -s 04:00.1 -v | grep -i sr-iov

# boot option
sle15:~ # vi /etc/default/grub
...
...
# grub
sle15:~ # grub2-mkconfig -o /boot/grub2/grub.cfg

# udev
sle15:~ # vi /etc/udev/rules.d/69-persistent-net_vf_num.rules
SUBSYSTEM=="net", ACTION=="add", DRIVERS=="ixgbe|i40e", ATTR{dev_id}=="0x0", ATTR{type}=="1", ATTR{device/sriov_numvfs}="8"

sle15:~ # vi /etc/udev/rules.d/70-persistent-net.rules
...
sle15:~ # vi /etc/udev/rules.d/72-persistent-net_vf_mac_addr.rules
...
sle15:~ # rmmod ixgbe
sle15:~ # modprobe ixgbe

sle15:~ # udevadm control --reload
sle15:~ # udevadm trigger
sle15:~ # udevadm info /sys/class/net/ixgbe0
sle15:~ # udevadm info -a /sys/class/net/ixgbe0
sle15:~ # udevadm info -q path /sys/class/net/ixgbe0
sle15:~ # udevadm test /sys/class/net/ixgbe0
sle15:~ # ls /sys/class/net/ixgbe0/

sle15:~ # ls -ld /sys/class/net/ixgbe0/device/virtfn*
